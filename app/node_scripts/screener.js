...
var screener=function(){
	...
	screener.prototype.initHardCodes=function(){
		...
		this.hardCodes.push(new hardCodedItem('@album','Photo Album','галерея','ფოტო ალბომი'));
		...
		this.hardCodes.push(new hardCodedItem('@success','Succesfull','запрос отправлен','მოთხოვნა მიღებულია'));
		this.hardCodes.push(new hardCodedItem('@error','Problem Occured,Try again','Ошибка, попробуйте еще раз','შეცდომა, კიდევ სცადეთ'));
